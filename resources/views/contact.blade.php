    ...
    <div class="row mt-2">
      ...
      <div class="col-md-6 d-flex align-items-stretch">
        <div class="info-box">
          ...
          <h3>My Address</h3>
          <p>Kampung Ciburial RT. 004 RW. 005<br>Ds./Kel. Tugu Utara Kec. Cisarua Bogor</p>
        </div>
      </div>

      <div class="col-md-6 mt-4 mt-md-0 d-flex align-items-stretch">
        <div class="info-box">
          <i class="bx bx-share-alt" style="font-size: 50px" ></i>
      ...
      <div class="col-md-6 mt-4 d-flex align-items-stretch">
        <div class="info-box">
          <i class="bx bx-envelope" style="font-size: 50px"></i>
          <h3>Email Me</h3>
          <p>georizkinugroho@smkwikrama.sch.id</p>
        </div>
      </div>
      <div class="col-md-6 mt-4 d-flex align-items-stretch">
        <div class="info-box">
          <i class="bx bx-phone-call" style="font-size: 50px"></i>
          <h3>Call Me</h3>
          <p>+62-838-1143-2036</p>
        </div>
      </div>
    </div>
